            ...
            {cartItems.length > 0 ? (
              cartItems?.map((item) => (
                <>
                  <div
                    key={item?.id}
                    className="p-5 bg-[#fff] flex flex-col item-start md:flex-row md:items-center lg:items-center xl:items-center  xl:p-10 gap-3 xl:gap-14 "
                  >
                    <img
                    ...
                    <button
                      ...
                      variant="outline"
                      size="icon"
                      className="hidden md:block lg:block xl:block uppercase bg-red-700 text-white text-base font-Public px-4 py-1 hover:bg-red-800 rounded-md"
                    >
                      Add to cart
                    </button>
                    <button
                  ...
                  <button
                    ...
                    variant="outline"
                    size="icon"
                    className="md:hidden lg:hidden xl:hidden block w-full uppercase bg-red-700 text-white text-base font-Public px-4 py-1 hover:bg-red-800 rounded-md"
                  >
                    Add to cart
                  </button>
                  </div>
