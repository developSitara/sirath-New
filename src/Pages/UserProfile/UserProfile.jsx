...
const UserProfile = () => {
  return (
    <div className="relative  w-full lg:mt-5 py-5 lg:py-10 px-4 sm:px-6 md:px-6 lg:px-8 xl:px-10">
      <div className="w-full flex gap-5 min-h-screen relative">
        {/* Sidebar */}
        <div className="w-1/4 bg-[#91A2B633] shadow-md sticky top-20 h-screen flex flex-col">
          ...
          <div className="w-full p-6 flex-1 px-14">
            <div className="">
              <h3 className="font-semibold text-2xl font-Public">Account Setting</h3>
            ...
            <div className="mt-8">
              ...
              <ul className="flex flex-col mt-2 space-y-2 text-gray-500">
                <NavLink to="/profile/wishlist" className={({ isActive }) =>
                    `cursor-pointer font-normal text-base font-Public hover:text-darkgrey ${
                      isActive ? "text-darkgrey font-semibold" : ""
                    }`
                  }>My Wishlist</NavLink>
                <NavLink to="/profile/pagenothere"  className={({ isActive }) =>
                    `cursor-pointer font-normal text-base font-Public hover:text-darkgrey ${
                      isActive ? "text-darkgrey font-semibold" : ""
                    }`
                  }>My Orders</NavLink>
        ...
        <div className="w-3/4 overflow-y-auto h-auto">
          <Outlet />
        </div>
      </div>
    </div>
