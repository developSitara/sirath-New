...
const testimonials = [
  ...
  },
  {
    ...
    clientName: "John Doe",
    profession: "CEO",
    des: "“Lorem Ipsum is simply dummcy text of the printing and typesetting industry.”",
  },
  {
    user: client,
...
const Testimonials = () => {
  ...
  return (
    <div className="block sm:hidden md:hidden lg:hidden xl:hidden mt-7 py-5 px-4 bg-blue text-white">
