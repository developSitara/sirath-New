...
const TopCategoryCard = ({ img, productName }) => {
  ...
  return (
    <div onClick={()=>getCatgeoryName(productName)} className="w-full p-2  cursor-pointer  flex flex-col items-center text-center group hover:bg-[#fff] rounded-lg transition-all duration-300 ease-in-out">
      {/* Image with Fixed Size */}
      <div className="bg-[#fff]  w-full h-auto  flex justify-center items-center overflow-hidden  ">
        <img
          src={img}
          alt={productName}
